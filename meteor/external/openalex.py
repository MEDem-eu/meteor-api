...
class OpenAlex:
    ...
    def resolve_doi(self, doi: str) -> dict:
        ...
        for i, author in enumerate(j["authorships"]):
            ...
            try:
                parsed_author["orcid"] = author["author"]["orcid"].replace(
                    "https://orcid.org/", ""
                )
            except:
                pass
        ...
        try:
            ...
            try:
                result["description"] = " ".join(
                    list(j["abstract_inverted_index"].keys())
                )
            except:
                pass
    ...
    def get_author_name(self, author_id: str) -> dict:
        ...
        if "orcid" in j:
            result["orcid"] = j["orcid"].replace("https://orcid.org/", "")
    ...
    def get_author_ids(self, query: str) -> list:
        ...
        params = {"search": query**self.params}
